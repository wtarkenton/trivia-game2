...
var qestionEL= document.getElementById('question');
...
function loadQuestion (questionsIndex) {
  var q = qestions[questionsIndex];
  qestionEL.textContent = (questionsIndex + 1) + '. ' + q.questions;
  opt1.textContent = q.otion1;
  opt2.textContent = q.otion2;
  opt3.textContent = q.otion3;
  opt4.textContent = q.otion4; 
};

function loadQuestion() {  //shouldnt be blue querySelector
